              ...
              <div id="frmdiv" class="ui-widget-content minipage">
                ...
                <table style="margin: auto; border: solid 1pt lightgrey">
                  <tr>
                    <td class="alignright">
                      <b>
                        <asp:Label ID="L_ProjectID" ForeColor="#CC6633" runat="server" Text="Project ID :" /><span style="color: red">*</span></b>
                    </td>
                    <td>
                      <asp:TextBox
                        ID="F_ProjectID"
                    ...
                    <td class="alignright">
                      <b>
                        <asp:Label ID="L_MRNNo" ForeColor="#CC6633" runat="server" Text="MRN No :" /><span style="color: red">*</span></b>
                    </td>
                    <td>
                      <asp:TextBox
                        ID="F_MRNNo"
                  ...
                  <tr>
                    <td class="alignright">
                      <b>
                        <asp:Label ID="L_SerialNo" ForeColor="#CC6633" runat="server" Text="Serial No :" /><span style="color: red">*</span></b>
                    </td>
                    <td colspan="3">
                  ...
                  <tr>
                    <td class="alignright">
                      <b>
                        <asp:Label ID="Label1" runat="server" Text="Link ERP IRN :" /><span style="color: red">*</span></b>
                    </td>
                    <td colspan="3">
                      <asp:TextBox ID="F_IRNO"
                        Text='<%# Bind("IRNO") %>'
                        ToolTip="Select IR No from List."
                        Enabled="False"
                        CssClass="dmytxt"
                        Width="78px"
