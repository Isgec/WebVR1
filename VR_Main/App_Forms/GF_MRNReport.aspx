<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_MRNReport.aspx.vb" Inherits="GF_MRNReport" title="MRN Report" %>
<asp:Content ID="CPHlgDMisg" ContentPlaceHolderID="cph1" Runat="Server">
  <div id="div1" class="page">
<asp:UpdatePanel ID="UPNLlgDMisg" runat="server">
  <ContentTemplate>
    <asp:Label ID="LabellgDMisg" runat="server" Text="&nbsp;MRN Report" Width="100%" CssClass="sis_formheading"></asp:Label>
    ...
    <script type="text/javascript">
      ...
      function print_report(o) {
       ...
       function script_download(fd, td, typ) {
       	pcnt = pcnt + 1;
       	var nam = 'wdwd' + pcnt;
       	var url = self.location.href.replace('App_Forms/GF_MRNReport.aspx', 'App_Downloads/MRNReport.aspx');
...
--%>				<tr>
				<td colspan="2">
					<input type="button" onclick="return script_download('<%= F_FromRequestNo.ClientID %>','<%= F_ToRequestNo.ClientID %>','<%= Txt_ProjectID.ClientID %>');" value=" Download " />
				</td>
			</tr>
    </table>
  </td></tr></table>
